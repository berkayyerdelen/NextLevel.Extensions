...
namespace NextLevel.Extensions.Tests.StringExtensions
{
    public  class StringExtensionsTest
    {
        ...
        {
            var text = "12";
            Assert.Equal(12, text.ToIntWithDefaultValue(5));
        }
        ...
        {
            var text = "this is test";
            var temptext = text.Strip("this","that");
